...
import torchvision
from dataloader import RandomLoader_combined, RandomLoader
...
def parse_option():
    ...
    args.filename = 'dr_dataset{}_{}_{}_{}_{}_{}_{}_{}_lr_{}_decay_{}_bsz_{}_warmup_{}_trial_{}_addp_{}'. \
...
def main():
    ...
    json_list = ['/home/mcz/2022Fall/DoublyRight/GPT3/cifar10_text.json',
                 '/home/mcz/2022Fall/DoublyRight/GPT3/cifar100_text.json',
                 '/home/mcz/2022Fall/DoublyRight/GPT3/food101_text.json',
                 '/home/mcz/2022Fall/DoublyRight/GPT3/caltech101_text.json',
                 'Our_ImageNet_attribute.json',
                 '/home/mcz/2022Fall/DoublyRight/GPT3/SUN_text.json']
    import json
    emb_attcat_list = []
    text_attcat_list = []
    ...
    Dr_rootpath = '/proj/DoubleRightDatasetOOD_split/cifar10_dr'
    ...
    if args.dataset == 'ImageNet':
        train_dataset = RandomLoader(f'{Dr_rootpath}/train',
                                              composed_transforms=preprocess224_interpolate)
        train_json_path = 'Our_ImageNet_attribute.json'

    elif args.dataset == 'cifar10':
        train_dataset = RandomLoader('/proj/DoubleRightDatasetOOD_split/cifar10_dr/train',
                                     composed_transforms=preprocess224_interpolate)
        train_json_path = '/home/mcz/2022Fall/DoublyRight/GPT3/cifar10_text.json'

    elif args.dataset == 'cifar100':
        train_dataset = RandomLoader('/proj/DoubleRightDatasetOOD_split/cifar100_dr/train',
                                     composed_transforms=preprocess224_interpolate)
        train_json_path = '/home/mcz/2022Fall/DoublyRight/GPT3/cifar100_text.json'

    elif args.dataset == 'food101':
        train_dataset = RandomLoader('/proj/DoubleRightDatasetOOD_split/food101_dr/train',
                                     composed_transforms=preprocess224_interpolate)
        train_json_path = '/home/mcz/2022Fall/DoublyRight/GPT3/food101_text.json'

    elif args.dataset == 'caltech101':
        train_dataset = RandomLoader('/proj/DoubleRightDatasetOOD_split/caltech101_dr/train',
                                     composed_transforms=preprocess224_interpolate)
        train_json_path = '/home/mcz/2022Fall/DoublyRight/GPT3/caltech101_text.json'

    elif args.dataset == 'SUN':
        train_dataset = RandomLoader('/projDoubleRightDatasetOOD_split/SUN_dr/train',
                                     composed_transforms=preprocess224_interpolate)
        train_json_path = '/home/mcz/2022Fall/DoublyRight/GPT3/SUN_text.json'

    assert  args.dataset in name_test_list
    for cid, e in enumerate(name_list):
        if e == args.dataset:
            train_text = text_attcat_list[cid]
            train_emb_text = emb_attcat_list[cid]
            break
    ...
    for epoch in range(args.epochs):
        ...
        train(train_loader, all_attribute, all_caten, model, model_text, model_image, prompter, add_prompter,
              optimizer, scheduler,
              criterion, scaler, epoch, args, attcat2int, train_emb_text)

        # evaluate on validation set
        if epoch % args.validate_freq == 0:
            dr_acc, dr_bl_acc = dr_validate(epoch, model_text, model_image, prompter, add_prompter, criterion, args,
                                            name_list, root_path_list, json_list, emb_attcat_list,
                                            text_attcat_list, name_test_list)
            print('double right', dr_acc, dr_bl_acc)
...
def train(train_loader, attributes_all, categories_all, model, model_text, model_image, prompter, add_prompter,
          optimizer, scheduler, criterion, scaler, epoch, args, attcat2int, dr_text_emb):
    """
